...
public class tricep extends JFrame 
{
    ...
    tricep()
    {
        ...
        JLabel l=new JLabel("Close bench press 12*3sets");
        l.setBounds(10,170,200,20);
        l.setForeground(Color.BLUE);
        p2.add(l);
        
        ImageIcon squats=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t1.gif"));
        ...
        add(p3);
         ...
         ImageIcon s=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t2.gif"));
        ...
        JLabel p=new JLabel("cable rope tricep push 12*3sets");
        ...
        ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t3.gif"));
        ...
        JLabel pa=new JLabel("triceps extension 12*3 sets");
        pa.setBounds(20,170,200,20);
        ...
        add(p5);
         ...
         ImageIcon t=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t4.gif"));
        ...
        JLabel paa=new JLabel("Triceps dips 12*4");
        ...
        ImageIcon n=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t5.gif"));
        ...
        JLabel pan=new JLabel("Diamond pushups 12*3 set");
        pan.setBounds(20,170,200,20);
        ...
        ImageIcon j=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/t6.gif"));
        ...
        JLabel panj=new JLabel("bench dips 12*2 sets");
       ...
       /* jj.addMouseListener(new MouseAdapter()
        ...
        ImageIcon jump=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/pu2.gif"));
        ...
        JLabel jn=new JLabel("push ups 12*3 sets");
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                String str="insert into tricep values(?,?,?,?,?)";
