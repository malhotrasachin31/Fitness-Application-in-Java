...
public class yogavibes extends JFrame 
{
    ...
    yogavibes()
    {
        ...
        JLabel l=new JLabel("SIRSASANA");
        l.setBounds(50,170,150,20);
        l.setForeground(Color.BLUE);
        p2.add(l);
        
        ImageIcon squats=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo1.gif"));
        ...
        add(p3);
         ...
         ImageIcon s=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo2.gif"));
        ...
        JLabel p=new JLabel("SARVANGASANA");
        ...
        ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo3.gif"));
        ...
        add(p5);
         ...
         ImageIcon t=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo4.gif"));
        ...
        JLabel paa=new JLabel("MATSYASANA");
        ...
        ImageIcon n=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo5.gif"));
        ...
        JLabel pan=new JLabel("PASCIMOTTANASANA");
        ...
        ImageIcon j=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo6.gif"));
        ...
        JLabel panj=new JLabel("BHUJANGASANA");
        ...
        ImageIcon jump=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo7.gif"));
        ...
        JLabel jn=new JLabel("SALABHASNA");
        ...
        ImageIcon nc=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo8.gif"));
        ...
        JLabel panc=new JLabel("DHANURASANA");
        ...
        ImageIcon sm=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo9.gif"));
        ...
        JLabel pank=new JLabel("ARDHAMATSYASANA");
        ...
        ImageIcon f=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo10.gif"));
        ...
        JLabel fk2=new JLabel("KAKASANA");
        ...
        ImageIcon lr=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo11.gif"));
        ...
        JLabel leg=new JLabel("PADAHASTASANA");
        ...
        ImageIcon run=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/yo12.gif"));
        ...
        JLabel pan4=new JLabel("TRIKONASANA");
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                String str="insert into yogareport values(?,?,?,?)";
