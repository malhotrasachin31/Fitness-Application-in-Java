...
public class legs extends JFrame 
{
    ...
    legs()
    {
        ...
        add(p3);
         ...
         ImageIcon s=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/jj.gif"));
        ...
        JLabel p=new JLabel(" jumping jacks 20*4 seconds");
        ...
        add(p5);
         ...
         ImageIcon t=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/sk.gif"));
        ...
        JLabel paa=new JLabel("skipping 500 reps");
        ...
        JLabel panc=new JLabel("30 mountain climbers*3 sets");
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                String str="insert into legs values(?,?,?,?,?)";
                pst=conn.prepareStatement(str);
                pst.setString(1, one);
                pst.setString(2,two);
                pst.setString(3, three);
                pst.setString(4,sdf.format(date));
                pst.setString(5, sdf2.format(date));
