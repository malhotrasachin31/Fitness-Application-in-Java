...
public class chest extends JFrame 
{
    ...
    chest()
    {
        ...
        JLabel l=new JLabel("Bench Press 12*3");
        l.setBounds(20,170,200,20);
        l.setForeground(Color.BLUE);
        p2.add(l);
        
        ImageIcon squats=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c1.gif"));
        ...
        ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c2.gif"));
        ...
        JLabel pa=new JLabel("pec dec 12*3");
        ...
        add(p5);
         ...
         ImageIcon t=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c3.gif"));
        ...
        JLabel paa=new JLabel("forward crossover 12*4");
        ...
        ImageIcon jump=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c4.gif"));
        ...
        JLabel jn=new JLabel("Chest Press 12*3 set");
        ...
        ImageIcon nc=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/pu2.gif"));
        ...
        JLabel panc=new JLabel("20 pushups * 3 set");
        ...
        ImageIcon sm=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c5.gif"));
        ...
        JLabel pank=new JLabel("Chest dips 12*2 sets");
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                String str="insert into chest values(?,?,?,?,?)";
