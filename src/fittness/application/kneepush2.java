...
public class kneepush2 extends JFrame
{
    JPanel p1;
    JButton b2;
    ...
    kneepush2()
    {
        ...
        add(p1);
          ...
          ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/kp.gif"));
        ...
        JLabel jj=new JLabel("Knee Push-ups of 10 reps");
