...
public class sixthday extends JFrame implements ActionListener
{
    JPanel p1;
    JTextArea ta;
    JButton b1;
    ...
    sixthday() 
    {
        ...
        r1=new JRadioButton("BENCH PRESS");
        ...
        r7=new JRadioButton("CHEST PRESS");
       ...
       JLabel l5=new JLabel("SIXTH DAY 8 WORKOUTS");
       ...
       add(l5);
        ...
        // adding gifs
         ...
         ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c1.gif"));
        ...
        JLabel jj=new JLabel("Bench Press 12*3 reps");
       ...
       JLabel wp=new JLabel("Wide Arm push-ups  *8");
        ...
        add(wp);
          ...
          ImageIcon s=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/squats.gif"));
       ...
       JLabel inc2=new JLabel("squats 12*5 reps");
        inc2.setBounds(1730,270,350,20);
        inc2.setFont(f2);
        add(inc2);
        
          ImageIcon de=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c4.gif"));
       ...
       JLabel kpe2=new JLabel("Chest Press 12*3 reps");
        kpe2.setBounds(720,500,200,20);
        kpe2.setFont(f2);
        add(kpe2);
        
      
        ImageIcon i11=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/c.gif"));
        Image i12=i11.getImage().getScaledInstance(250, 250,Image.SCALE_DEFAULT);
       ...
       JLabel push=new JLabel("Crunches 12*3 reps");
...
"Make It a Habit.";
        ...
        b1.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
                ...
                String str="insert into sixthday values(?,?,?,?,?)";
