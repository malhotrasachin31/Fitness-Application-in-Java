...
public class pushup2 extends JFrame
{
      JPanel p1;
    JButton b2;
    ...
    pushup2()
    {
        ...
        add(p1);
          ...
          ImageIcon i=new ImageIcon(ClassLoader.getSystemResource("fittness/application/images/pu.gif"));
        ...
        JLabel jj=new JLabel("Push-ups of 8 reps");
        jj.setBounds(120,500,450,40);
        jj.setFont(f1);
        add(jj);
